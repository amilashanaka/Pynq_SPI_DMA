...
HD_PWD='C:/Projects/ERN24004/Projects/PYNQ/05_SPI_DMA/Fir/Fir.runs/Fir_filter_axi_quad_spi_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Fir_filter_axi_quad_spi_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Fir_filter_axi_quad_spi_0_0.tcl
