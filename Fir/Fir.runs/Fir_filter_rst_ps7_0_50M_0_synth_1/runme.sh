...
HD_PWD='C:/Projects/ERN24004/Projects/PYNQ/03_Fir/Fir/Fir.runs/Fir_filter_rst_ps7_0_50M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Fir_filter_rst_ps7_0_50M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Fir_filter_rst_ps7_0_50M_0.tcl
