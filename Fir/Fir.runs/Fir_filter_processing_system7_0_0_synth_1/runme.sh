...
EAStep vivado -log Fir_filter_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Fir_filter_processing_system7_0_0.tcl
